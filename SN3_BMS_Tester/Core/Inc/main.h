...
#define CS_4_Pin GPIO_PIN_0
#define CS_4_GPIO_Port GPIOB
#define CS_5_Pin GPIO_PIN_1
#define CS_5_GPIO_Port GPIOB
#define CS_6_Pin GPIO_PIN_2
...
#define CS_8_Pin GPIO_PIN_9
#define CS_8_GPIO_Port GPIOA
#define CS_9_Pin GPIO_PIN_10
#define CS_9_GPIO_Port GPIOA
#define CS_10_Pin GPIO_PIN_11
#define CS_10_GPIO_Port GPIOA
#define CS_11_Pin GPIO_PIN_12
#define CS_11_GPIO_Port GPIOA
#define Start_Pin GPIO_PIN_11
#define Start_GPIO_Port GPIOC
#define A3B3_Pin GPIO_PIN_3
#define A3B3_GPIO_Port GPIOB
