...
#define FEB_CAN_ID_APPS_BRAKE_PEDAL 0x0
#define FEB_CAN_ID_APPS_CURRENT 0x1
#define FEB_CAN_ID_SWS_MESSAGE_READY_TO_DRIVE 0x2

#define LVPDB_LV_CURRENT 0x3
#define LVPDB_EX_CURRENT 0x4
#define LVPDB_CP_CURRENT 0x5
