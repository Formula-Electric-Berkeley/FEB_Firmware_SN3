...
//ICS
#define FEB_CAN_ID_ICS_READY_TO_DRIVE 0x5
#define FEB_CAN_ID_ICS_BUTTON_2 0x6
#define FEB_CAN_ID_ICS_BUTTON_3 0x7
#define FEB_CAN_ID_ICS_BUTTON_4 0x8
#define FEB_CAN_ID_ICS_COOLANT_PUMP 0x9
#define FEB_CAN_ID_ICS_RADIATOR_FANS 0xa
#define FEB_CAN_ID_ICS_ACUMULATOR_FANS 0xb
#define FEB_CAN_ID_ICS_TEST 0xc

//APPS
#define FEB_CAN_ID_APPS_BRAKE_PEDAL 0xd
